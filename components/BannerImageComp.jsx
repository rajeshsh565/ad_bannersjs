...
const BannerImageComp = ({initialBannerData, updateEditBanner, isPreview=false}) => {
  const [bannerInfo, setBannerInfo] = useState(initialBannerData);
  const handleBannerInfo = (data)=> {
    setBannerInfo(data);
  }
  return (
    <div
    ...
    >
      ...
      <svg
        ...
        onClick={()=>{updateEditBanner({bannerInfo, handleBannerInfo})}}
      >
        <path
          strokeLinecap="round"
